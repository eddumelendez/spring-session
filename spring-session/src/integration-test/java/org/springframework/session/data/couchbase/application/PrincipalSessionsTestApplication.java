...
@EnableCouchbaseHttpSession(timeoutInSeconds = PrincipalSessionsTestApplication.SESSION_TIMEOUT, principalSessionsEnabled = PrincipalSessionsTestApplication.PRINCIPAL_SESSIONS_ENABLED)
