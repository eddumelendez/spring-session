...
@EnableCouchbaseHttpSession(timeoutInSeconds = ExpirationTestApplication.SESSION_TIMEOUT, principalSessionsEnabled = ExpirationTestApplication.PRINCIPAL_SESSIONS_ENABLED)
public class ExpirationTestApplication {
	...
	public SessionRepository sessionRepository(CouchbaseDao dao, ObjectMapper mapper,
			SessionDataConverter converter) {
		return new ImmediateSessionExpirationRepository(dao, mapper, SESSION_TIMEOUT,
				converter, PRINCIPAL_SESSIONS_ENABLED);
	}
